...
<BlogChatPrompt prompt="What would Nobi's search return for a misspelled query like 'wireless headphons' on my catalog?" />
...
<BlogEmailCapture hook="Losing search traffic to Amazon? See how Nobi handles typos, intent, and mobile on your store." prompt="What would Nobi's search return for a misspelled query like 'wireless headphons' on my catalog?" />
