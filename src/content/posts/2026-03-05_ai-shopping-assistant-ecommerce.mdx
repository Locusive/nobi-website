...
<BlogEmailCapture hook="Exploring AI shopping assistants for your store?" prompt="What does an AI shopping assistant actually do that regular site search can't?" />
