export const meta = {
 ...
 {
 question: "1. Nobi",
 answer: "Nobi is an AI customer support tool that runs on your website. It answers product questions, handles site search, and deflects tickets before they're filed. Pricing is $25/month flat with no seat fee and no per-resolution charge — so the bill scales with usage, not team size."
 },
 {
 question: "2. Zendesk",
 answer: "Zendesk Suite with Copilot starts at $155/agent/month annual. It's not cheaper than Intercom at small scale — it's an alternative when your real bottleneck is ticket routing, macros, and SLA tracking, not visitor questions arriving on your site. If your team already lives in Zendesk, adding AI there makes more sense than switching platforms."
 },
 {
 question: "3. Forethought",
 answer: "Forethought layers AI onto Zendesk, Salesforce, or Kustomer — auto-resolving tickets and helping agents close the rest faster. Pricing is quote-only. It doesn't run on your website and only helps after a ticket is filed, so it's the right call when you want AI inside a helpdesk you already run, not before the ticket exists."
 },
 {
 question: "4. Kustomer",
 answer: "Kustomer is a full CX platform with AI Agents for Customers and AI Copilot for agents built in. Pricing is quote-only and the migration is multi-quarter. It's the right call when you're replacing your helpdesk anyway and want AI inside the new platform from day one — not when you just need a cheaper way to answer website questions."
 },
 {
