...
<BlogEmailCapture hook="Losing customers to Amazon's search experience?" prompt="What would Nobi's search return on my store for a misspelled query like 'wireles headphns'?" />
