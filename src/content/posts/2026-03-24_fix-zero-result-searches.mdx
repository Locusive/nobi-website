...
# How to Fix Zero-Result Searches on Your Ecommerce Store
...
**Your zero-result rate.** What percentage of search queries return zero products? Check your search analytics dashboard. Most search platforms (Algolia, Elasticsearch, Searchspring) track this automatically. If you're above 10%, this should be a top priority.
