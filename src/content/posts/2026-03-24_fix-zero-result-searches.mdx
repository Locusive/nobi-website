...
<BlogChatPrompt prompt="What's the fastest way to cut zero-result searches on a Shopify store without retagging the whole catalog?" />
...
<BlogEmailCapture hook="Want to see your store's actual zero-result rate? Get a free Nobi search audit." prompt="What's the fastest way to cut zero-result searches on a Shopify store without retagging the whole catalog?" />
