...
<BlogChatPrompt prompt="How does Nobi handle automated support compared to Intercom for an ecommerce store?" />
...
<BlogEmailCapture hook="Comparing Nobi and Intercom? See how Nobi answers your shoppers' questions with cited sources." prompt="How does Nobi handle automated support compared to Intercom for an ecommerce store?" />
