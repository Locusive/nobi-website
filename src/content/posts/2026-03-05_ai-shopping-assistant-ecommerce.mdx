...
<BlogEmailCapture hook="Trying to figure out if an AI shopping assistant is worth adding to your store? Drop your email and we'll show you exactly how Nobi answers shopper questions on your catalog." prompt="What does an AI shopping assistant actually do that regular site search can't?" />
