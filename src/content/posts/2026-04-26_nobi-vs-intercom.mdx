...
<BlogChatPrompt prompt="How would Nobi handle automated support on a Shopify store with a 5,000-product catalog?" />
...
<BlogEmailCapture hook="Comparing Nobi and Intercom? Get a side-by-side breakdown on your catalog." prompt="How would Nobi handle automated support on a Shopify store with a 5,000-product catalog?" />
