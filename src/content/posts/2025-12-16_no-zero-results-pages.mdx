...
<BlogChatPrompt prompt="How would Nobi handle a zero-result search for a product we don't carry on our store?" />
...
<BlogEmailCapture hook="Tired of zero-result searches losing sales? See what Nobi surfaces on your catalog." prompt="How would Nobi handle a zero-result search for a product we don't carry on our store?" />
