...
<BlogEmailCapture hook="Site search converting below the 4.6% benchmark on your store?" subtext="Drop your email and we'll show you how Nobi's AI search interprets shopper intent and surfaces the right products for queries your current search is missing." />
