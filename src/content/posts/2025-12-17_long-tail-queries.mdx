...
<BlogEmailCapture hook="Losing long-tail searches like 'red dress for a summer wedding'?" subtext="Drop your email and we'll show you how Nobi's AI search parses natural-language queries and surfaces the right products instead of returning zero results." />
