...
Amazon has spent over two decades training shoppers to expect search that just works, and there's [a lot ecommerce stores can learn from Amazon's search experience](/blog/amazon-search-experience-ecommerce). Think about what happens when you search Amazon:
...
<BlogQualifier context="shoppers leaving for Amazon's search experience" />
...
<BlogEmailCapture hook="Losing shoppers to Amazon's faster, smarter search experience?" subtext="Drop your email and we'll show you how Nobi's AI search understands shopper intent and surfaces the right products on your store, the way Amazon does on theirs." />
## Three Things You Can Do This Week

**1. Audit your [zero-result rate](/blog/fix-zero-result-searches).** Pull your search analytics. What percentage of searches return no results? If it's above 5%, you have a leaking bucket that needs fixing immediately.
