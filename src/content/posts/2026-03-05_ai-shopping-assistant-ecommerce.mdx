...
<BlogEmailCapture hook="Curious if an AI shopping assistant fits your store? See Nobi on your catalog." prompt="What does an AI shopping assistant actually do that regular site search can't?" />
