...
<BlogEmailCapture hook="Comparing Constructor, Algolia, and Bloomreach for ecommerce search?" subtext="Drop your email and we'll run Nobi - AI-native site search that answers shopper questions with cited sources - on your catalog so you can benchmark it against Constructor, Algolia, and Bloomreach." />
