...
<BlogEmailCapture hook="Trying to lift your site search conversion rate past the benchmarks? Drop your email and we'll show you exactly which queries Nobi would fix on your catalog." prompt="What's a realistic site search conversion rate to aim for on a mid-market fashion catalog?" />
