...
<BlogEmailCapture hook="Comparing Gorgias, Zendesk, and Octane AI for your store?" prompt="What does it take to launch an AI shopping assistant on a Shopify store this week?" />
