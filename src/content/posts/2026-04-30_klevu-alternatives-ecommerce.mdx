...
<BlogEmailCapture hook="Looking for a Klevu alternative for ecommerce site search?" subtext="Drop your email and we'll run Nobi - an AI search layer that understands shopper intent - alongside Klevu, Algolia, and Searchspring on your catalog so you can compare results head-to-head." />
