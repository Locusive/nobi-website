...
<BlogEmailCapture hook="Fixing zero-result pages with Algolia or Klevu?" prompt="How would Nobi handle a zero-result search for a misspelled product name on my store?" />
