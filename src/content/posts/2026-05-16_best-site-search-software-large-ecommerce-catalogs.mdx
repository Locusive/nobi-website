export const meta = {
 ...
 {
 question: "1. Nobi",
 answer: "Nobi combines AI site search with a shopping assistant on one platform, so the same semantic ranker covers shoppers typing odd conversational queries in the search bar and shoppers asking questions on a product page. Answers are grounded in your connected catalog and policy sources, which refresh twice a day so price changes and new collections land quickly. The standard plan starts at $25/month for catalogs up to 5,000 SKUs; catalogs above that are on enterprise pricing - contact Nobi for a quote, as enterprise discounts are common."
 },
 {
 question: "2. Algolia",
