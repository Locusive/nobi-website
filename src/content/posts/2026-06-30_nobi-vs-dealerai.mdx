...
Nobi is a [conversational website assistant](https://nobi.ai/blog/best-conversational-ai-used-car-dealerships) that combines inventory search, grounded shopper Q&A, and [lead capture](/blog/dealership-lead-capture) in one product. [DealerAI](https://dealerai.com) runs separate AI agents for Sales, Service, Parts, and Finance (what it calls a Multi-Agent Generative System) and reaches shoppers across the dealership website, Facebook, Instagram, and SMS from its base tier.
