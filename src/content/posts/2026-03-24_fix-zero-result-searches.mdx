...
<BlogEmailCapture hook="Trying to fix zero-result searches on your store? Drop your email and we'll show you exactly what Nobi would surface for the queries that are losing you revenue today." prompt="What's a realistic zero-result rate to aim for after switching to AI-powered site search?" />
