...
<BlogEmailCapture hook="Comparing Searchspring, Algolia, Klevu, and Fast Simon for rule-based boosting and pinning? Drop your email and we'll show you how Nobi handles merchandising rules on your catalog." prompt="How does Nobi handle merchandising rules and pinned products compared to Searchspring or Algolia?" />
