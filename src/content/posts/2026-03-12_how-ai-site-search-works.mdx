...
<BlogEmailCapture hook="Tired of keyword search missing what shoppers actually mean?" subtext="Drop your email and we'll show you how Nobi's AI search understands intent and surfaces the right products for the fuzzy queries your store is currently missing." />
