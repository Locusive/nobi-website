...
<BlogChatPrompt prompt="What does Nobi do when a shopper's search returns zero results on my catalog?" />
...
<BlogEmailCapture hook="Want to see how Nobi handles the search behaviors shoppers actually use? Get a walkthrough on your catalog." prompt="What does Nobi do when a shopper's search returns zero results on my catalog?" />
