...
<BlogEmailCapture hook="Picking an ecommerce platform with native AI search built in?" subtext="Drop your email and we'll show you how Nobi's AI search and shopping assistant layer onto your existing store to surface the right products for queries your search is missing today." />
