export const meta = {
 ...
 description: "Salesforce Commerce Cloud's keyword search misses descriptive queries. Add Nobi to resolve natural-language searches from your connected catalog.",
 excerpt: "Salesforce Commerce Cloud's keyword search misses descriptive queries. Add Nobi to resolve natural-language searches from your connected catalog.",
