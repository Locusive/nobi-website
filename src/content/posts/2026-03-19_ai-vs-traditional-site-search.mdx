...
<BlogEmailCapture hook="Comparing AI search to your current site search? See how Nobi performs on your catalog." prompt="How would an AI shopping assistant handle a query like 'waterproof jacket for hiking under $150' that traditional site search usually returns zero results for?" />
...
<BlogChatPrompt prompt="How would an AI shopping assistant handle a query like 'waterproof jacket for hiking under $150' that traditional site search usually returns zero results for?" />
