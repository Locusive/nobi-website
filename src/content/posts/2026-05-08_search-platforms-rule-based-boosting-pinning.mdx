...
<BlogEmailCapture hook="Comparing Searchspring, Algolia, Klevu, and Fast Simon for merchandising rules?" subtext="Drop your email and we'll show you how Nobi's AI search applies your boosting and pinning rules while surfacing the right products for queries your store is currently missing." />
