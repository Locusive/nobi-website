    ...
    <PageLayout>
      <div className="bg-white text-black min-h-screen">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center border-b border-slate-100 bg-[#0a0a12] px-6 py-20 gap-12 relative overflow-hidden">
          ...
          <div className="relative w-full max-w-2xl">
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-[#111118]">
              ...
              {/* Chat body */}
              <div className="px-8 pt-16 pb-24 flex flex-col items-center gap-8">
          ...
          <div className="w-full max-w-2xl rounded-3xl border border-slate-200 bg-white shadow-xl overflow-hidden">
            ...
            <div className="p-5 space-y-3">
              ...
              {[
                ...
                <div key={i} className="rounded-xl border border-slate-100 bg-slate-50 px-4 py-2.5 space-y-1">
                  <div className="flex items-start gap-2">
        ...
        <section id="beat-3" className="min-h-screen flex flex-col items-center justify-center border-b border-slate-100 bg-[#0a0a12] px-6 py-20 gap-10 relative overflow-hidden">
          ...
          <div className="relative w-full max-w-lg rounded-3xl border border-white/10 bg-[#111118] overflow-hidden shadow-2xl">
            {/* Search header */}
            <div className="px-5 py-4 border-b border-white/5 flex items-center gap-3">
              <div className="flex-1 flex items-center gap-2 rounded-xl bg-white/5 border border-white/8 px-4 py-2">
                ...
                <span className="text-sm text-white/50">luxury cashmere sweater gift</span>
              </div>
              <span className="flex items-center gap-1.5 text-xs text-violet-400 flex-shrink-0">
            ...
            <div className="p-4 space-y-2">
              {[
                ...
                <div key={r.name} className={`flex items-center gap-4 rounded-2xl px-5 py-3.5 border transition-all ${r.highlight ? "border-violet-500/40 bg-violet-500/10" : "border-white/5 bg-white/3 opacity-20"}`}>
                  <div className={`h-2 w-2 rounded-full flex-shrink-0 ${r.highlight ? "bg-emerald-400" : "bg-white/20"}`} />
                  <div className="flex-1 min-w-0">
                    <div className={`text-sm font-semibold ${r.highlight ? "text-white" : "text-white/40"}`}>{r.name}</div>
                    <div className="text-xs text-white/25">{r.url}</div>
                  </div>
        ...
        <section id="beat-4" className="min-h-screen flex flex-col items-center justify-center border-b border-slate-100 bg-white px-6 py-20 gap-10">
          ...
          <div className="text-center space-y-3 max-w-2xl">
            <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900">Their AI reached out to your business's AI agent.</h2>
