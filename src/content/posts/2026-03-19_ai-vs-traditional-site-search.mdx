...
<BlogEmailCapture hook="Weighing AI search against your current site search? See how Nobi performs on your catalog." prompt="How would an AI shopping assistant handle a vague query like \"something warm for a beach wedding\" better than keyword search?" />
...
<BlogChatPrompt prompt="How would an AI shopping assistant handle a vague query like \"something warm for a beach wedding\" better than keyword search?" />
