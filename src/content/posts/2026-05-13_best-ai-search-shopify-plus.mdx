...
<BlogQualifier context="Algolia, Klevu, Searchspring, and Fast Simon for Shopify Plus search" />
...
<BlogEmailCapture hook="Picking AI search for your Shopify Plus store?" subtext="Drop your email and we'll run Nobi's AI search on your catalog so you have a real data point alongside Algolia, Klevu, Searchspring, and Fast Simon." />
