...
<BlogEmailCapture hook="Adding AI support on top of your existing help desk?" prompt="How does Nobi sit on top of an existing Zendesk or Intercom help desk without replacing it?" />
