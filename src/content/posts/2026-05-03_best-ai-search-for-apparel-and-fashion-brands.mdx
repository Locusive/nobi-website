...
<BlogEmailCapture hook="Picking AI search for your apparel store?" prompt="How would Nobi handle a shopper searching for 'wedding guest dress under $200' on an apparel site?" />
