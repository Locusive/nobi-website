...
<BlogChatPrompt prompt="How does Nobi sit on top of Zendesk or Intercom without replacing the help desk we already use?" />
...
<BlogEmailCapture hook="Already on Zendesk or Intercom? See what Nobi adds without ripping out your help desk." prompt="How does Nobi sit on top of Zendesk or Intercom without replacing the help desk we already use?" />
