...
1. **Catalog names that don't match shopper words.** This could be the biggest one on apparel, home goods, and beauty sites. Your catalog uses creative names ("Cappuccino", "Chelsea"); shoppers type plain ones ("brown", "slip-on").
