...
The catalog sync piece carries the most day-to-day risk. Prices, inventory counts, and variants change constantly. If your index lags, search surfaces products that have sold out or changed price - and if you've added a conversational layer, it answers from the same stale data, telling a visitor a size is available when it isn't or quoting last week's price. Keeping the index current isn't a one-time setup; it's ongoing engineering work you own permanently.
