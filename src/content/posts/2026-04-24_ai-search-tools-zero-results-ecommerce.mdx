...
<BlogChatPrompt prompt="What percentage of my searches are returning zero results, and which queries are driving that?" />
...
<BlogEmailCapture hook="See how Nobi handles the zero-result searches your current site search is missing." prompt="What percentage of my searches are returning zero results, and which queries are driving that?" />
