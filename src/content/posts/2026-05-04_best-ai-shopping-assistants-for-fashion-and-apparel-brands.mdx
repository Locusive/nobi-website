...
<BlogEmailCapture hook="Picking between Octane AI, Rep AI, and Alby for fashion?" prompt="Which AI shopping assistant fits a fashion brand with a wide size and fit range?" />
