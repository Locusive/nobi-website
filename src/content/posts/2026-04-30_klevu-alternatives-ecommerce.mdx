...
<BlogQualifier context="Algolia, Searchspring, and Findify as Klevu alternatives" />
...
<BlogEmailCapture hook="Weighing Klevu alternatives like Algolia, Searchspring, or Findify?" subtext="Drop your email and we'll run Nobi's AI site search on your catalog so you have a real data point alongside Algolia, Searchspring, and Findify." />
