...
Traditional site search works by matching the exact words a shopper types to the words in your product titles, descriptions, and tags. This creates a fundamental problem: shoppers and merchants [describe the same products using completely different language](/blog/semantic-search-vs-keyword-search).
...
<BlogQualifier context="AI shopping assistants for their ecommerce store" />
...
<BlogEmailCapture hook="Curious how an AI shopping assistant performs on your catalog?" subtext="Drop your email and we'll show you how Nobi's AI shopping assistant answers product questions and surfaces the right items for shoppers on your store." />
## What to Look for in an AI Shopping Assistant

Not all [AI shopping assistants](/blog/best-ai-shopping-assistants-for-ecommerce) are created equal. Some are enterprise platforms that take months to implement and cost six figures. Others are thin wrappers around basic autocomplete. Here's what actually matters:
...
**Low zero-result rates.** Ask any vendor what their average [zero-result rate](/blog/fix-zero-result-searches) is. If they can't answer or the number is above 5%, keep looking.
