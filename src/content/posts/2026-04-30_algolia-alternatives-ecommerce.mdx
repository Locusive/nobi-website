...
<BlogEmailCapture hook="Looking for an Algolia alternative without a dev team?" subtext="Drop your email and we'll show you how Nobi - an AI search and shopping assistant that installs without developer work - surfaces the right products for the queries your store is currently missing." />
