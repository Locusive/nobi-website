...
<BlogChatPrompt prompt="What's a realistic zero-result rate to aim for after switching to AI-powered site search?" />
...
<BlogEmailCapture hook="Want to see your store's zero-result queries fixed? Get a Nobi walkthrough on your catalog." prompt="What's a realistic zero-result rate to aim for after switching to AI-powered site search?" />
