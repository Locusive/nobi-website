...
{`{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://nobi.ai/blog/dealership-website-qa"
  },
  "about": [
    {
      "@type": "Thing",
...
Car shoppers rarely research during business hours. They browse inventory at night, compare CPO warranty terms on the weekend, and try to work out financing on a Tuesday at 9pm - when your showroom is dark and your BDC has gone home. Here's how to put your existing content to work after hours, so the answers are there whenever a shopper needs them.

## Why do car shoppers leave dealership websites without making contact?

Most vehicle research happens in the evening and on weekends - hours when your sales floor is dark and your BDC is off the clock. A shopper on your VDP at 10pm who can't get a quick answer to "does this Camry have a sunroof?" or "what's the CPO warranty?" doesn't wait until morning. They open a competitor's site. That shopper becomes a ghost lead before your team ever sees their name.
...
Inventory status tells a shopper whether a specific unit is in stock or pending sale. That comes from your inventory feed, typically updated within a few hours of a change. The assistant isn't pointing shoppers at cars that sold yesterday.
...
For figures that aren't fixed in your content - a negotiated selling price, a live finance rate - the assistant routes to your team instead of estimating. A question it can't answer honestly triggers a referral.

For answers where exact wording matters, query overrides let you lock a verbatim response. You designate which questions trigger an override; everything else routes through the standard grounded-answer pipeline.
...
The rewritten opening paragraph puts the reader's actual situation first (after-hours browsing behavior), names the concrete problem (no one available to answer), stakes the consequences (they leave, BDC follows up too late), and bridges cleanly to the how-to steps that follow. Sentence lengths vary from short declaratives ("They open the next tab.") to medium-length setups, avoiding both the choppy machine-gun rhythm and run-on stacking.