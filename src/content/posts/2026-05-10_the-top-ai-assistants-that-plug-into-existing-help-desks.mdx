...
<BlogChatPrompt prompt="How does Nobi sit on top of an existing Zendesk or Intercom help desk without replacing it?" />
...
<BlogEmailCapture hook="Already running a help desk? See where Nobi plugs in and what it deflects." prompt="How does Nobi sit on top of an existing Zendesk or Intercom help desk without replacing it?" />
