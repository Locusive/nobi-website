export const meta = {
 ...
 {
 question: "1. Nobi",
 answer: "Nobi is an AI shopping assistant grounded in your catalog and policy documents. It finds products and answers shopper questions directly on your site, with inline citation pills on every answer. Merchants can lock exact verbatim responses to return policy and compliance questions. Pricing starts at $25/month with no revenue share. The honest weakness is channel reach: web chat only, no SMS or email. Pick it when shoppers can't find the right product or aren't getting fast answers on the page."
 },
 {
...
- **Nobi** - [AI shopping assistant](/blog/best-ai-shopping-assistants-for-ecommerce) that finds products and answers questions on your site, grounded in your catalog and policy docs, $25/mo base (2,500 searches and 250 messages included). Pick when on-site product discovery and customer Q&A are the conversion gap.
...
Nobi is $25/month base, including 2,500 searches and 250 conversational messages, then $0.01 per extra search and $0.10 per extra message. Tidio runs $24-$49/month with Lyro as a paid add-on. The two solve different jobs, as our [Nobi vs Tidio breakdown](/blog/nobi-vs-tidio) lays out, so the headline price only matters if both tools are real candidates for your specific conversion gap.
