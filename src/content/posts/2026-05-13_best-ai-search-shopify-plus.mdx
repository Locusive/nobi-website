export const meta = {
 title: "The Best AI Search for Shopify Plus Brands",
...
{`{
  ...
  "@type": "Article",
  "headline": "The Best AI Search for Shopify Plus Brands",
  "description": "A head-of-ecommerce comparison of the AI search tools that integrate cleanly with Shopify Plus brands - pricing, fit, and trade-offs for each.",
