...
<BlogEmailCapture hook="Curious how an AI shopping assistant would perform on your catalog? See it live." prompt="What does an AI shopping assistant actually do that regular site search can't?" />
...
<BlogChatPrompt prompt="What does an AI shopping assistant actually do that regular site search can't?" />
