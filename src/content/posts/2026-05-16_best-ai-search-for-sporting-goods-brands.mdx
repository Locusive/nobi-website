export const meta = {
 title: "The Best AI Search for Sporting Goods Brands",
...
{`{
  ...
  "@type": "Article",
  "headline": "The Best AI Search for Sporting Goods Brands",
  "description": "Compare AI search tools built for sporting goods catalogs - sport-intent queries, deep attribute filters, and multi-category gear, apparel, and consumables.",
