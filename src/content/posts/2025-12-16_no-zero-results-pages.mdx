...
<BlogEmailCapture hook="Curious whether RAG-powered search would actually outperform keyword matching on your store? Drop your email and we'll show you exactly what Nobi surfaces on your catalog." prompt="How would Nobi handle a zero-result search on my store's catalog?" />
