...
<BlogEmailCapture hook="Still seeing zero-result pages tank conversions on your store?" subtext="Drop your email and we'll show you how Nobi's AI search interprets shopper intent and surfaces relevant products for the queries your catalog currently returns nothing for." />
