...
<BlogEmailCapture hook="Site search killing your conversion rate?" prompt="How would an AI shopping assistant handle a query like 'waterproof jacket for hiking under $150' that traditional site search usually returns zero results for?" />
