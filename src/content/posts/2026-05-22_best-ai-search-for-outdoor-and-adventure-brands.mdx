...
**Cons:**
- Klevu is now a division of [Athos Commerce, the parent that also owns Searchspring and Intelligent Reach](/blog/athos-commerce-alternatives-ecommerce)
...
**Verdict:** Pick Fast Simon if visual collection curation leads your discovery model and search needs are basic; skip it if conversational trip-language queries are what's costing you sales. See our [Fast Simon alternatives for ecommerce](/blog/fast-simon-alternatives-ecommerce) for other options in this lane.
...
Trip-language search against a technical outdoor catalog is a specific problem, and most site search wasn't built for it. The same challenge shows up for [sporting goods brands](/blog/best-ai-search-for-sporting-goods-brands) whose shoppers query by activity rather than SKU. If that's the gap you're trying to close, you can see how Nobi works at nobi.ai, or start a 30-day free trial - no sales call required. After the trial, pricing starts at $25/mo.
