...
- **[Algolia](https://algolia.com)** - Developer-first search API with programmatic control over rules, ranking, and synonyms. Usage-based pricing, typically $2k+/mo at scale. Pick it when a search engineer will own the rule engine and you want full API control over the stack.
