...
<BlogEmailCapture hook="Losing sales to zero-result searches on your store?" prompt="How would Nobi handle a zero-result search for a misspelled product name on my store?" />
