...
<BlogEmailCapture hook="Losing sales to bad site search results?" prompt="What revenue lift could Nobi deliver on a catalog with high zero-result search rates?" />
