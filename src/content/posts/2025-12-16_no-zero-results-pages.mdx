...
<BlogEmailCapture hook="Tired of keyword search missing what shoppers actually mean?" subtext="Drop your email and we'll show you how Nobi - an AI search layer that reads your catalog and content - returns the right products for the natural-language queries your store is currently missing." />
