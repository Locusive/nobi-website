...
<BlogEmailCapture hook="Losing sales to bad site search on your store?" prompt="How much revenue could we recover if Nobi cut our zero-result search rate in half?" />
