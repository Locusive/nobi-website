export const meta = {
 ...
 {
 question: "1. Nobi",
 answer: "Nobi is an AI customer support tool that runs on your website. It handles site search, conversational answers, and customer Q&A in one product. Pricing starts at $25/month flat, with no seat fee and no $0.99-per-resolution meter. That makes the bill scale with usage instead of team size - a more predictable bill than Intercom's per-seat plus per-resolution charges."
 },
 {
 question: "2. Zendesk",
...
- **[Zendesk](https://zendesk.com)** - ticket platform with AI Agents and Copilot layered on top, $155/agent/mo annual (Suite + Copilot Professional) up to $209 Enterprise. Pick when ticket routing and macros are the real bottleneck, not visitor questions.
- **[Forethought](https://forethought.ai)** - AI layer that sits on top of Zendesk, Salesforce, or Kustomer; quote-only with a platform fee plus usage on AI-resolved tickets and ticket volume routed to agents. Pick when keeping your current helpdesk is non-negotiable.
- **[Kustomer](https://kustomer.com)** - full customer experience platform with AI Agents for Customers and AI Copilot built in; quote-only enterprise pricing and a multi-quarter migration. Pick when you're replacing your helpdesk anyway.
...
Nobi is an [AI customer support tool](https://nobi.ai/blog/best-ai-chatbot-for-customer-support) that runs directly on your website. It handles site search, conversational answers, and customer Q&A. Most repetitive questions get answered before a ticket is opened. You pay a flat base plus a few cents per use. Intercom charges per seat plus $0.99 every time Fin answers. There's no seat fee and no per-resolution meter, so the bill scales with usage instead of team size - a more predictable bill for a founder watching every line item.
