...
Not with bad product photos or slow shipping. With the search bar. The one tool these high-intent shoppers rely on is broken on the majority of ecommerce sites, and [the revenue impact is massive](/blog/cost-of-bad-site-search).
...
Consider the math. If search users [convert at 2-3x the rate of browsers](/blog/site-search-conversion-rate-benchmarks), and they generate 45% of your revenue despite being only 15% of traffic, then the ROI on improving their experience is massive. A 10% improvement in search conversion could mean a 4.5% improvement in total revenue. For a $5M store, that's $225,000/year.
...
<BlogQualifier context="site search losing sales on their store" />
