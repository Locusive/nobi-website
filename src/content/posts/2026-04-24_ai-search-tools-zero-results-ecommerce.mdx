...
<BlogChatPrompt prompt="How would Nobi handle a zero-result search for a misspelled product name on my store?" />
...
<BlogEmailCapture hook="Comparing AI search tools? See how Nobi handles zero-result queries on your catalog." prompt="How would Nobi handle a zero-result search for a misspelled product name on my store?" />
