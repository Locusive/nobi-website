...
The underlying shift is from exact match to [intent reading](/blog/what-is-natural-language-search). A shopper who types "cozy layering piece for the office" gets products tagged with knitwear, business casual, and layering, even if none of those terms appear in the query itself. The semantic layer reads meaning, not string similarity.
