...
<BlogChatPrompt prompt="How would Nobi handle a zero-result search on my store's catalog?" />
...
<BlogEmailCapture hook="Tired of zero-result searches losing sales? See how Nobi handles your catalog." prompt="How would Nobi handle a zero-result search on my store's catalog?" />
