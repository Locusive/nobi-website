...
<BlogEmailCapture hook="Losing sales to zero-result searches on your store?" prompt="What's a realistic zero-result rate to aim for after switching to AI-powered site search?" />
