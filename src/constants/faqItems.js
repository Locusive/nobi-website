export const FAQ_ITEMS = [
    ...
    },
    {
        ...
        a: "Nobi is designed for quick setup. Most implementations can go live within minutes. We provide documentation and support to make the process as smooth as possible.",
        category: "Implementation",
    },
    {
        q: "What integrations does Nobi support?",
        a: "Nobi integrates with major ecommerce platforms and can be customized to work with your specific tech stack. Contact our team for details on your platform.",
        category: "Implementation",
    },
    {
        q: "How much does Nobi cost?",
        a: "Pricing depends on your store's size and needs. We offer flexible plans to accommodate businesses of all sizes. Contact us for a custom quote.",
        category: "Pricing",
    },
    {
    ...
    {
        q: "What kind of support does Nobi provide?",
        a: "We provide comprehensive support including documentation, email support, and dedicated account management for enterprise customers.",
        category: "Support",
    },
    {
        q: "How does Nobi handle data security?",
