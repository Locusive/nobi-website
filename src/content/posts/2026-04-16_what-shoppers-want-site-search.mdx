...
<BlogChatPrompt prompt="What does Nobi do when a shopper searches for something my catalog doesn't carry?" />
...
<BlogEmailCapture hook="Want to see how your current site search stacks up against what shoppers actually expect?" prompt="What does Nobi do when a shopper searches for something my catalog doesn't carry?" />
