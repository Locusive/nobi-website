...
<BlogEmailCapture hook="Losing shoppers to Amazon because your site search can't keep up?" subtext="Drop your email and we'll show you how Nobi's AI search handles typos, learns from shopper behavior, and surfaces the right products so customers buy from you instead of bouncing to Amazon." />
