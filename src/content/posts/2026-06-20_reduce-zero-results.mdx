...
[Contextual suggestion pills](/blog/suggestion-pills) reduce zero-result attempts before they happen. On each page, Nobi displays tappable recommended prompts matched to what visitors on that page typically want to know. A shopper who doesn't know where to start clicks a pill instead of typing something that might not resolve.
