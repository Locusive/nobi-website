...
<BlogEmailCapture hook="Adding an AI shopping assistant to your ecommerce store?" prompt="What does an AI shopping assistant actually do that regular site search can't?" />
