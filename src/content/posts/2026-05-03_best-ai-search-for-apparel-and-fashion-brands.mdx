...
<BlogChatPrompt prompt="How would Nobi handle a shopper searching for 'a dress for a fall wedding under $150' on an apparel catalog?" />
...
Nobi pairs semantic site search with a [conversational assistant](https://nobi.ai/blog/ai-shopping-assistant-ecommerce) and automatic customer Q&A on one bill. Personalization works out of the box. The trade-off: Nobi only works on search results and conversational inquiries, not category or collection pages.
...
<BlogEmailCapture hook="Comparing Algolia, Coveo, or Hawk for your apparel store? See Nobi run on your catalog." prompt="How would Nobi handle a shopper searching for 'a dress for a fall wedding under $150' on an apparel catalog?" />
