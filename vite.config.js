...
export default defineConfig({
  ...
  plugins: [
    ...
    // for local dev and bundled preview so the pricing calculator's URL lookup works against
    // the real SimilarWeb endpoint without CORS issues.
    {
      name: 'traffic-lookup-dev',
      configureServer: installTrafficLookup,
      configurePreviewServer: installTrafficLookup,
    },
  ],
})

function installTrafficLookup(server) {
