...
<BlogEmailCapture hook="Trying to figure out which AI search tool will actually kill zero-result pages on your store? Drop your email and we'll show you exactly what Nobi would surface on your catalog." prompt="How would Nobi handle a zero-result search for a misspelled product name on my store?" />
