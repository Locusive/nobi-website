...
<BlogChatPrompt prompt="How would Nobi handle a query like 'red dress for a summer wedding under $200' on my store?" />
...
<BlogEmailCapture hook="Want to see Nobi parse long-tail queries on your own catalog? Get a walkthrough." prompt="How would Nobi handle a query like 'red dress for a summer wedding under $200' on my store?" />
