export const meta = {
  ...
  author: "Nobi Team",
  heroImage: "https://storage.googleapis.com/nobi-public/docs_and_marketing_websites/posts/best-ai-search-ecommerce-2026/hero.png",
  featured: true,
  draft: false,
  faqItems: [
    {
...
{`{
  ...
  "mentions": [
    ...
    { "@type": "Product", "name": "Athos Commerce" },
...
| Nobi | AI site search + conversational shopping assistant | Shopify / Shopify Plus brands wanting CVR lift in days, not months | $25/mo base for 2,500 searches & 250 messages <br />Then $0.01/search and $0.10/message | Search, conversational AI, and lead capture in one platform with proven CVR lift (UNTUCKit +17.1%) | No site-wide merchandising outside of the search results screen |
...
**Pricing:** [Starts at $25/month](https://nobi.ai/pricing) for 2,500 searches and 250 conversational messages, with $0.01 per additional search and $0.10 per additional message. No revenue-share, no per-seat fees, no AI features gated behind higher tiers. A store running 50,000 searches lands around $500/month (and Nobi offers volume-based discounts) - math you can do yourself before signing anything.
...
If one flat per-unit-priced plan that handles AI site search, a conversational shopping assistant, and lead capture in the same place sounds like what you need, <a href="https://dashboard.nobi.ai">try Nobi free for 30 days</a>.
