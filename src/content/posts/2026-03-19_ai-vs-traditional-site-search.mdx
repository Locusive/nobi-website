...
<BlogEmailCapture hook="Weighing whether to upgrade from traditional site search to an AI shopping assistant? Drop your email and we'll show you how Nobi handles real shopper questions on your catalog." prompt="How would an AI shopping assistant handle a query like 'waterproof jacket for hiking under $150' that traditional site search usually returns zero results for?" />
