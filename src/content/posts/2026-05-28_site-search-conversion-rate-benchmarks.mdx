...
<BlogEmailCapture hook="Trying to lift conversion rate with better site search?" prompt="What's a realistic site search conversion rate to aim for on a mid-market fashion catalog?" />
