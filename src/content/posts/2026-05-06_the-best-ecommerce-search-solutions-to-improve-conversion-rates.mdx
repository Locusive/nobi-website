...
<BlogEmailCapture hook="Picking between Algolia, Klevu, Constructor, and Fast Simon for search?" subtext="Drop your email and we'll show you how Nobi's AI search surfaces the right products for the queries your store is currently missing - and run it alongside the others on your catalog." />
