...
<BlogChatPrompt prompt="How much revenue could we recover if Nobi cut our zero-result search rate in half?" />
...
<BlogEmailCapture hook="Want a read on what bad search is costing your store? Get the breakdown." prompt="How much revenue could we recover if Nobi cut our zero-result search rate in half?" />
