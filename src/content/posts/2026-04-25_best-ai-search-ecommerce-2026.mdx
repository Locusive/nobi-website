export const meta = {
  ...
  description: "Compare the top AI ecommerce search platforms covering visual search, semantic search, and hybrid ranking - with pricing, features, and who each fits best.",
  excerpt: "Compare the top AI ecommerce search platforms covering visual search, semantic search, and hybrid ranking - with pricing, features, and who each fits best.",
