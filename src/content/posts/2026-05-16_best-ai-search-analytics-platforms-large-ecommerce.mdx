export const meta = {
 ...
 answer: "Bloomreach folds search analytics into a broader Discovery suite that includes marketing automation. Pricing is modular and quoted by usage. It's the right pick when search analytics sit inside a larger customer-data play rather than standing on their own."
 },
 {
 question: "4. Coveo",
 answer: "Coveo wraps query reporting inside its enterprise search suite and unifies search across 30+ content sources. Base plans start at $600/month, with annual contracts at $50k+ and implementation fees on top. Pick it when you need search across product, knowledge, and support content in one index."
 },
 {
 question: "5. Algolia",
...
- **Coveo** - enterprise-grade reporting with governance and audit tooling, spanning commerce, support, and workplace surfaces. Base at $600/mo, with annual licensing at $50k+ and $20k+ implementation fees on top. Pick when search analytics has to satisfy enterprise audit requirements.
...
- Transparent per-unit pricing ($0.01/search, $0.10/message), so analytics traffic spikes don't produce surprise bills
