...
<BlogEmailCapture hook="Picking an AI shopping assistant for your fashion brand?" prompt="Which AI shopping assistant fits a fashion brand with a wide size and fit range?" />
