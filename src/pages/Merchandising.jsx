            ...
            <div className="space-y-8 max-w-3xl">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold leading-[1.05] text-slate-900 text-balance">
                  Search results <span className={GRADIENT}>you control</span>
                </h1>
                <p className="text-lg text-slate-600 max-w-2xl leading-relaxed">
                  Boost seasonal products, bury out-of-stock SKUs, pin promoted items, and hide what doesn't belong. Semantic relevance plus your business rules.
                </p>
              ...
              {[
                {
                  ...
                  desc: "Lift measured across customers using Nobi search with merchandising rules applied.",
                  palette: "blue",
                },
                {
                  stat: "+10.6%",
                  label: "average order value",
                  desc: "Lucchese saw AOV increase from $925 to $1,023 after Nobi search launched with merchandising controls.",
                  palette: "purple",
                },
                {
                  stat: "Minutes",
                  label: "to set a rule",
                  desc: "Merchandising rules are set in the dashboard, no code changes, no deploys. Changes take effect immediately.",
                  palette: "blue",
                },
              ].map((item) => (
                <div
          ...
          <div className="mx-auto max-w-6xl xl:max-w-7xl px-6 space-y-5 sm:space-y-8">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {[
                {
                  icon: Sparkles,
                  title: "Boost products for specific queries",
                  desc: "Pin seasonal items, new arrivals, or promoted SKUs to the top of results for relevant searches. Semantic ranking still handles everything else.",
                },
                {
                  icon: ShoppingCart,
                  title: "Bury and hide what shouldn't surface",
                  desc: "Push out-of-stock items to the bottom, hide clearance from full-price searches, or remove products from specific query results entirely.",
                },
                {
                  icon: BarChart3,
                  title: "Slot-based pinning",
                  desc: "Control exactly which position a product appears in. Pin your best-seller to slot 1 for a specific search term without losing relevance for everything else.",
                },
                {
                  icon: Search,
                  title: "No-code rule builder",
                  desc: "Set boost, bury, pin, and hide rules from the dashboard. Changes go live immediately with no code deployments.",
                },
              ].map((card) => {
              ...
              {[
                {
                  ...
                  desc: "Nobi indexes your product catalog and starts applying semantic ranking out of the box. No configuration required to get started.",
                },
                {
                  step: "2",
                  title: "Add your business rules",
                  desc: "Open the merchandising dashboard and set boost, bury, pin, or hide rules for any product or query. Changes preview before they go live.",
                },
                {
                  step: "3",
                  title: "Measure the impact",
                  desc: "See how each rule affects click-through and conversion in the analytics dashboard. A/B test rule changes to make sure they're helping.",
                },
              ].map((item) => (
                <div
                  key={item.step}
            ...
            <div className="space-y-8 text-center">
              <div className="space-y-4">
                ...
                <p className="text-lg text-white/70 max-w-2xl mx-auto leading-relaxed">
                  Set up your first merchandising rules in minutes using the no-code dashboard.
                </p>
              </div>
