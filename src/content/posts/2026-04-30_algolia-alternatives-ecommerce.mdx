...
<BlogChatPrompt prompt="Can Nobi replace Algolia on a Shopify store without writing any frontend code?" />
...
<BlogEmailCapture hook="Leaving Algolia? See what Nobi looks like on your catalog in under a day." prompt="Can Nobi replace Algolia on a Shopify store without writing any frontend code?" />
