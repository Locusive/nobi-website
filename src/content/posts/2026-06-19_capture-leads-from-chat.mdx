...
1. **"What is Nobi" section** - the full paragraph "That sequence is what separates it from a popup..." is a pure restatement of the preceding paragraph.
2. **"Configure" section** - two sentences claiming proactive features Nobi doesn't have yet: "Nobi's proactive engagement feature runs separately..." and "It can surface a capture prompt as a suggestion pill, a toast...or an exit-intent card..."
3. **HubSpot paragraph** - closing summary sentence "That context is the difference between a generic first touch and one that lands."
4. **Dashboard section** - two closing restatement sentences: "That data lets you make configuration decisions..." and "That downstream data is where the capture program's real return shows up..."
5. **Follow-up section** - closing restatement "Relevance is the lever most brands underuse..."
...
A shopper who types a question has raised their hand. That's a stronger intent signal than any passive page view or time-on-page proxy - and it's the signal most stores are ignoring when they optimise for list growth over contact quality.
...
The only change is the paragraph after `## How do you capture leads from an ecommerce chat assistant?`. It now opens with the reader's actual situation (popup as the default tool, who it actually catches), names the concrete problem (your highest-intent visitors - the ones asking real questions - slip through that system), states the stakes (you lose contact info from the people most likely to buy), and hands off to the guide.