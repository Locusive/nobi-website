...
<BlogChatPrompt prompt="What's a realistic site search conversion rate to aim for on a mid-market apparel store?" />
...
<BlogEmailCapture hook="Want your own site search conversion benchmarks? See how Nobi performs on your catalog." prompt="What's a realistic site search conversion rate to aim for on a mid-market apparel store?" />
