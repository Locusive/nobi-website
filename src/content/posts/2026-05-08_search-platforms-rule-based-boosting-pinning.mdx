...
<BlogChatPrompt prompt="How does Nobi handle rule-based boosting and pinning compared to Searchspring or Algolia?" />
...
<BlogEmailCapture hook="Comparing boosting and pinning across platforms? Get a side-by-side on your catalog." prompt="How does Nobi handle rule-based boosting and pinning compared to Searchspring or Algolia?" />
