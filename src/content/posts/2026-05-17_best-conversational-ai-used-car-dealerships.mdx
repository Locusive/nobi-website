...
[Impel](https://impel.ai) bills itself as an Automotive AI Operating System. The scope is the pitch: lead engagement, service scheduling, and lifecycle marketing under one contract. The 2024 Outsell acquisition added a marketing layer on top. If you're a dealer-group GM tired of stitching point tools together, Impel is the consolidation play - one vendor across the whole customer journey, integrated with major OEM platforms so franchise rooftops can plug in without custom integration work.
