...
<BlogEmailCapture hook="Picking between Algolia, Coveo, and Hawk Search for fashion?" prompt="How would Nobi handle a shopper searching for 'wedding guest dress under $200' on an apparel site?" />
