...
Start here: the best results page is the one your relevance ranking produces on its own. When search understands what shoppers mean, it surfaces the right products without your help - and every override you add is a small bet against that. So the goal of merchandising isn't to use these controls a lot. It's to use them as little as you can get away with.

There are real exceptions. Search results don't know about your sale that starts Friday. They don't know you're sitting on 300 units of a jacket that needs to move, or that a new colorway just dropped and nobody's found it yet. Those are genuine business reasons to step in - briefly, narrowly, and with a plan to step back out. But reach for a boost or a bury reflexively, or leave them stacked up after the reason has passed, and you get a results page that looks curated and reads as broken. If you find yourself writing rule after rule just to make search usable, that's not a merchandising problem - it's a sign your ranking is the thing to fix. Nobi's boost, bury, pin, and hide controls sit on top of AI ranking for the moments the business genuinely needs them, not as a substitute for search that works.
