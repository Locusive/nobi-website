...
<BlogChatPrompt prompt="Why are shoppers missing products we actually have in stock, and how would Nobi surface them in search?" />
...
<BlogEmailCapture hook="See which in-stock products your search is hiding from shoppers - on your live catalog." prompt="Why are shoppers missing products we actually have in stock, and how would Nobi surface them in search?" />
