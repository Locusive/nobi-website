export const meta = {
 ...
 description: "AI customer service explained: deflection bots, agent copilots, self-serve retrieval, and ticket triage - how each works, where it fits, and how to choose.",
 excerpt: "AI customer service explained: deflection bots, agent copilots, self-serve retrieval, and ticket triage - how each works, where it fits, and how to choose.",
 tags: ["support deflection", "generic", " search"],
...
<BlogEmailCapture hook="Never heard of AI customer service? Here's what it is." subtext="Drop your email and we'll show you how Nobi answers customer questions on your site with cited sources instead of a scripted chatbot." />
